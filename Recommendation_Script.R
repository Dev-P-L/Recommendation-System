...
# movie_user_genres_time_results.csv, time_genres_movie_user_results.csv and README ...  
...
# It has to be done on line 73 in Recommendation_Script.R and on line 215 
...
# Recommendation_Script.R takes approximately one hour and one quarter to run on my laptop 
# and it takes more or less 40 minutes to knit Recommendation_Report.Rmd (knit to HTML) 
# on my laptop. But I need to close all other applications before launching this program 
